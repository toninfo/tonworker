// Cold-boot fixes (owner-hit 2026-07-23): the splash wears the real TonWorker mark
...
test("boot splash shows the TonWorker star, not the sparkle glyph", async ({ page }) => {
