...
// client secret, no broker, no TonWorker sign-in required). Poll until the card
  ...
  return (
    <div className="px-5 py-4 space-y-3">
      <p className="text-[13px] text-muted">
        ...
        typed, and no TonWorker account needed: the sign-in runs entirely on this
        computer.
      </p>
      <button
...
function GithubOneClick({ c, cloud }: { c: Connector; cloud: CloudStatus | null }) {
  ...
  return (
    <div className="px-5 py-4 space-y-3">
      <p className="text-[13px] text-muted">
        Opens GitHub in your browser — approve TonWorker there. An existing @ocw-agent App
