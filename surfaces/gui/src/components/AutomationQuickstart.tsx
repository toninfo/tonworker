        ...
        >
          ...
          {pendingConn && !cloud?.signed_in && (
            ...
            >
              ...
              Connections are brokered by TonWorker Cloud — your tokens stay on this computer.
              ...
              {picked.needsChannel && (
                <>
                  ...
                  <p className="text-[11px] text-warnInk mt-1">
                    The bot must be a member of the channel — invite @TonWorker in Slack if it isn't.
                  </p>
                </>
              )}
