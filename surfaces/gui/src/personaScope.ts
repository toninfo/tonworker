...
// Persona naming: the product is "TonWorker"; the personas are a "Coworker" family — Coworker
...
// API + tests keep "TonWorker" / "Ops Coworker"); this is purely the display layer.
