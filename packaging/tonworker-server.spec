...
"""PyInstaller spec for the bundled `tonworker-server` (desktop sidecar).
...
# Onedir: dist/tonworker-server/{tonworker-server[.exe], _internal/}. The build scripts stage
